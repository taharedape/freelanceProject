...
(c) Dinamenta, UAB.
*/
gantt = { version: "4.0.0" }, gantt.event = function(t, e, n) { t.addEventListener ? t.addEventListener(e, n, !1) : t.attachEvent && t.attachEvent("on" + e, n) }, gantt.eventRemove = function(t, e, n) { t.removeEventListener ? t.removeEventListener(e, n, !1) : t.detachEvent && t.detachEvent("on" + e, n) }, gantt._eventable = function(t) {
        t._silent_mode = !1, t._silentStart = function() { this._silent_mode = !0 }, t._silentEnd = function() { this._silent_mode = !1 }, t.attachEvent = function(t, e, n) {
            ...
            return this._silent_mode ? !0 : (t = "ev_" + t.toLowerCase(), this[t] ? this[t].apply(this, e) : !0) }, t.checkEvent = function(t) {
            return !!this["ev_" + t.toLowerCase()] }, t._eventCatcher = function(t) {
            var e = [],
                n = function() {
            ...
            return n.addEvent = function(t) {
                return "function" == typeof t ? e.push(t) - 1 : !1 }, n.removeEvent = function(t) { e[t] = null }, n }, t.detachEvent = function(t) {
            if (t) {
                var e = t.split(":");
                this[e[0]].removeEvent(e[1])
            }
        }, t.detachAllEvents = function() {
            for (var t in this) 0 === t.indexOf("ev_") && delete this[t] }, t = null
        ...
        return a || t }, gantt.mixin = function(t, e, n) {
        for (var a in e)(!t[a] || n) && (t[a] = e[a]);
        return t }, gantt.defined = function(t) {
        return "undefined" != typeof t;
    }, gantt.uid = function() {
        return this._seed || (this._seed = (new Date).valueOf()), this._seed++, this._seed }, gantt.bind = function(t, e) {
        return t.bind ? t.bind(e) : function() {
            return t.apply(e, arguments) } }, gantt._get_position = function(t) {
        var e = 0,
            n = 0;
        ...
        var s = "_viewRestore";
        return this.vs[this[s]()].grid }), "undefined" != typeof window.dhtmlXCellObject && (dhtmlXCellObject.prototype.attachGantt = function(t, e, n) {
        n = n || window.gantt;
        var a = document.createElement("DIV");
    ...
    }, gantt._on_contextmenu = function(t) { t = t || window.event;
        var e = t.target || t.srcElement,
            n = gantt.locate(e),
            a = gantt.locate(e, gantt.config.link_attribute),
            i = !gantt.checkEvent("onContextMenu") || gantt.callEvent("onContextMenu", [n, a, t]);
        return i || (t.preventDefault ? t.preventDefault() : t.returnValue = !1), i }, gantt._find_ev_handler = function(t, e, n, a) {
        for (var i = !0; e;) {
        ...
        return i
    }, gantt._on_dblclick = function(t) { t = t || window.event;
        var e = t.target || t.srcElement,
            n = gantt.locate(t),
        ...
        if (a) {
            ...
            if (!i) return;
            null !== n && gantt.getTask(n) && a && gantt.config.details_on_dblclick && gantt.showLightbox(n) } }, gantt._on_mousemove = function(t) {
        if (gantt.checkEvent("onMouseMove")) {
            var e = gantt.locate(t);
            gantt._last_move_event = t, gantt.callEvent("onMouseMove", [e, t]) }
    }, gantt._DnD = function(t, e) { e && (this._settings = e), gantt._eventable(this), gantt.event(t, "mousedown", gantt.bind(function(n) { e.original_target = { target: n.target || n.srcElement }, this.dragStart(t, n) }, this)) }, gantt._DnD.prototype = {
        dragStart: function(t, e) {
            this.config = { obj: t, marker: null, started: !1, pos: this.getPosition(e), sensitivity: 4 }, this._settings && gantt.mixin(this.config, this._settings, !0);
            var n = gantt.bind(function(e) {
                    return this.dragMove(t, e) }, this),
                a = (gantt.bind(function(e) {
                    return this.dragScroll(t, e) }, this), gantt.bind(function(t) {
                    return gantt.defined(this.config.updates_per_second) && !gantt._checkTimeout(this, this.config.updates_per_second) ? !0 : n(t) }, this)),
                i = gantt.bind(function(e) {
                    return gantt.eventRemove(document.body, "mousemove", a), gantt.eventRemove(document.body, "mouseup", i), this.dragEnd(t) }, this);
        ...
        this._click.gantt_close = this.bind(function(t, e, n) {
            return this.close(e), !1 }, this), this._click.gantt_open = this.bind(function(t, e, n) {
            return this.open(e), !1 }, this), this._click.gantt_row = this.bind(function(t, e, n) {
            if (null !== e) {
            ...
            if (this.callEvent("onGridHeaderClick", [a, t])) {
                ...
                if (this.config.sort) {
                    for (var i, s = a, r = 0; this.config.columns.length; r++)
                        if (this.config.columns[r].name == a) { i = this.config.columns[r];
                            break }
            ...
            if (!this.config.readonly) {
                var a = {};
                return this.createTask(a, e ? e : this.config.root_id), !1 } }, this), this._init_resize && this._init_resize()
        ...
        for (var e = this.getGridColumns(), n = [], a = 0; a < e.length; a++) {
            var i, s, r = a == e.length - 1,
                o = e[a];
            "add" == o.name ? s = "" : (s = o.template ? o.template(t) : t[o.name],
    ...
    }, gantt.open = function(t) { gantt._set_item_state(t, !0), this.callEvent("onTaskOpened", [t]) }, gantt.close = function(t) { gantt._set_item_state(t, !1), this.callEvent("onTaskClosed", [t]) }, gantt._set_item_state = function(t, e) { t && this._pull[t] && (this._pull[t].$open = e, gantt._refresh_on_toggle_element(t)) }, gantt._refresh_on_toggle_element = function(t) { this.refreshData() }, gantt._is_grid_visible = function() {
        return this.config.grid_width && this.config.show_grid }, gantt._get_grid_width = function() {
        ...
        this.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity),
            t.attachEvent("onBeforeDragStart", this.bind(function(e, n) {
                ...
                var i = this.locate(n),
                    s = gantt.getTask(i);
                return gantt._is_readonly(s) ? !1 : (t.config.initial_open_state = s.$open, this.callEvent("onRowDragStart", [i, n.target || n.srcElement, n]) ? void 0 : !1) }, this)), t.attachEvent("onAfterDragStart", this.bind(function(e, n) {
                var a = this._locateHTML(n);
                ...
                return a ? a.id : null }, t._getGridPos = this.bind(function(t) {
                ...
                if (this.isTaskExists(l) || (l = t.lastTaskOfLevel(gantt.config.order_branch_free ? g.$level : 0),
                    ...
                    if (h.y + d.offsetHeight / 2 < r) {
                        ...
                        if (f) {
                            if (f.id == g.id) return;
                            c = f } else if (f = this._pull[this._order[u]], a(f, g) && f.id != g.id) return void this.moveTask(g.id, -1, this.getParent(f.id)) }
                ...
                this.callEvent("onBeforeRowDragEnd", [t.config.id, t.config.parent, t.config.index]) === !1 ? (this.moveTask(t.config.id, t.config.index, t.config.parent), e.$drop_target = null) : this.callEvent("onRowDragEnd", [t.config.id, e.$drop_target]), e.$transparent = !1, e.$open = t.config.initial_open_state, this.refreshData() }, this))
    }, gantt.getGridColumns = function() {
        return this.config.columns }, gantt._has_children = function(t) {
        return this.getChildren(t).length > 0;
    }, gantt._scale_helpers = {
        getSum: function(t, e, n) { void 0 === n && (n = t.length - 1), void 0 === e && (e = 0);
        ...
        processIgnores: function(t) { t.ignore_x = {}, t.display_count = t.count },
        ...
        initScaleConfig: function(t) {
            ...
            return this.eachColumn(t.unit, t.step, function(t) { e.count++, e.trace_x.push(new Date(t)) }), e },
        ...
        eachColumn: function(t, e, n) {
            ...
            var s = new Date(a);
            for (+s >= +i && (i = gantt.date.add(s, e, t)); + i > +s;) { n.call(this, new Date(s));
        ...
        set_actions: function() {
            ...
            gantt.event(t, "mousemove", gantt.bind(function(t) { this.on_mouse_move(t || event) }, this)), gantt.event(t, "mousedown", gantt.bind(function(t) { this.on_mouse_down(t || event) }, this)), gantt.event(t, "mouseup", gantt.bind(function(t) { this.on_mouse_up(t || event) }, this)) },
        ...
        on_mouse_move: function(t) { this.drag.start_drag && this._start_dnd(t);
            var e = this.drag;
            if (e.mode) {
                ...
                if (gantt.isTaskExists(n) && (a = gantt.getTask(n)), !gantt._is_readonly(a) && !this.drag.mode) {
                    ...
                    if (s)
                        if (s.mode && s.mode != gantt.config.drag_mode.ignore && gantt.config["drag_" + s.mode]) {
                            ...
                            s.start_x = r.x, s.start_y = r.y, s.obj = a, this.drag.start_drag = s } else this.clear_drag_state();
        ...
        _fix_dnd_scale_time: function(t, e) {
            ...
            gantt.config.round_dnd_dates || (i = "minute", s = gantt.config.time_step), e.mode == gantt.config.drag_mode.resize ? e.left ? (t.start_date = gantt.roundDate({
                ...
                unit: i,
                step: s
            }), n(t)) : (t.end_date = gantt.roundDate({ date: t.end_date, unit: i, step: s }), a(t)) : e.mode == gantt.config.drag_mode.move && (t.start_date = gantt.roundDate({ date: t.start_date, unit: i, step: s }), n(t), t.end_date = gantt.calculateEndDate(t.start_date, t.duration, gantt.config.duration_unit))
        },
        _fix_working_times: function(t, e) {
            ...
            gantt.config.work_time && gantt.config.correct_work_time && (e.mode == gantt.config.drag_mode.resize ? e.left ? t.start_date = gantt.getClosestWorkTime({
                date: t.start_date,
                dir: "future"
            }) : t.end_date = gantt.getClosestWorkTime({ date: t.end_date, dir: "past" }) : e.mode == gantt.config.drag_mode.move && gantt.correctTaskWorkTime(t))
        },
        ...
        e || (e = { mode: gantt.config.drag_mode.move }), gantt._tasks_dnd._fix_dnd_scale_time(t, e) }, gantt._render_link = function(t) {
        for (var e = this.getLink(t), n = gantt._get_link_renderers(), a = 0; a < n.length; a++) n[a].render_item(e) }, gantt._get_link_type = function(t, e) {
        var n = null;
        ...
        var s = !0;
        return this.checkEvent("onLinkValidation") && (s = this.callEvent("onLinkValidation", [i])), s }, gantt._render_link_element = function(t) {
        ...
        for (var o = 0; o < a.length; o++) { o == a.length - 1 && (a[o].size -= gantt.config.link_arrow_size);
        ...
        switch (e) {
            ...
            case a.dirs.down:
                i += 2 * r, s -= r }
        return n.style.cssText = ["top:" + i + "px", "left:" + s + "px"].join(";"), n.className = _, n }, gantt._drawer = {
        current_pos: null,
        dirs: { left: "left", right: "right", up: "up", down: "down" },
        path: [],
        clear: function() { this.current_pos = null, this.path = [] },
        point: function(t) { this.current_pos = gantt.copy(t) },
        get_lines: function(t) { this.clear(), this.point(t[0]);
        ...
        return t * gantt.config.row_height }, gantt._path_builder = {
        path: [],
        ...
        point_to: function(t, e, n) { n = n ? { x: n.x, y: n.y } : gantt.copy(this.point());
        ...
        function d() { l._direction && (l._direction.parentNode && l._direction.parentNode.removeChild(l._direction), l._direction = null) }
        var l = new gantt._DnD(this.$task_bars, { sensitivity: 0, updates_per_second: 60 }),
            g = "task_left",
            h = "task_right",
            c = "gantt_link_point",
        ...
        l.attachEvent("onBeforeDragStart", gantt.bind(function(e, n) {
            ...
            return !1
        }, this)), l.attachEvent("onAfterDragStart", gantt.bind(function(t, n) { e(l.config.marker) }, this)), l.attachEvent("onDragMove", gantt.bind(function(a, i) {
            var r = l.config,
                o = l.getPosition(i);
            n(r.marker, o);
            ...
            if (_ && (p = !gantt._locate_css(i, h), _ = !!f), gantt._link_target_task = f, gantt._link_landing = _, gantt._link_target_task_start = p, _) {
                var v = gantt.getTask(f),
                    ...
                    k = 0;
                m && (k = Math.floor(m.offsetWidth / 2)), this._dir_end = t(v, !!gantt._link_target_task_start, k) } else this._dir_end = gantt._get_mouse_pos(i);
            var b = !(g == _ && d == f && c == p);
            ...
            i(), t.from && gantt.refreshTask(t.from, !1), t.to && gantt.refreshTask(t.to, !1), d() }, this)), gantt._is_link_drop_area = function(t) {
            return !!gantt._locate_css(t, u);
        }
    }, gantt._get_link_state = function() {
        return { link_landing_area: this._link_landing, link_target_id: this._link_target_task, link_target_start: this._link_target_task_start, link_source_id: this._link_source_task, link_source_start: this._link_source_task_start } }, gantt._task_renderer = function(t, e, n, a) {
        return this._task_area_pulls || (this._task_area_pulls = {}), this._task_area_renderers || (this._task_area_renderers = {}), this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || this.assert(!1, "Invalid renderer call"),
            n && n.setAttribute(this.config.layer_attribute, !0), this._task_area_renderers[t] = {
                ...
                clear_container: function(t) { t = t || n, t && (t.innerHTML = "") },
                ...
                append: function(t, e, n) { e && (this.rendered[t.id] && this.rendered[t.id].parentNode ? this.replace_item(t.id, e) : n.appendChild(e), this.rendered[t.id] = e) },
                replace_item: function(t, e) {
                    var n = this.rendered[t];
                    n && n.parentNode && n.parentNode.replaceChild(e, n), this.rendered[t] = e },
                remove_item: function(t) { this.hide(t), delete this.rendered[t] },
                hide: function(t) {
        ...
        for (var t in this._task_area_renderers) this._task_renderer(t).unload() }, gantt._is_layer = function(t) {
        return t && t.hasAttribute && t.hasAttribute(this.config.layer_attribute) }, gantt._init_tasks = function() {
        function t(t, e, n, a) {
        ...
        this._tasks = { col_width: this.config.columnWidth, width: [], full_width: 0, trace_x: [], rendered: {} }, this._click.gantt_task_link = this.bind(function(t, e) {
            ...
            n && this.callEvent("onLinkClick", [n, t]) }, this), this._click.gantt_scale_cell = this.bind(function(t, e) {
            var n = gantt._get_mouse_pos(t),
            ...
            var e = this.locate(t),
                a = this.getTask(e),
                i = null;
            return n.parentNode && gantt._getClassName(n.parentNode) && (i = gantt._getClassName(n.parentNode).indexOf("_left") > -1 ? a.$target[0] : a.$source[0]), i && this._delete_link_handler(i, t), !1 }, this), this._tasks_dnd.init(), this._init_links_dnd(), this._link_layers.clear();
        ...
        return [] }, gantt._get_link_filters = function() {
        return [] }, gantt._is_chart_visible = function() {
        return !!this.config.show_chart }, gantt._filter_task = function(t, e) {
        var n = null,
            a = null;
        ...
        return this.config.show_links ? !gantt.isTaskVisible(e.source) || !gantt.isTaskVisible(e.target) || gantt._isAllowedUnscheduledTask(gantt.getTask(e.source)) || gantt._isAllowedUnscheduledTask(gantt.getTask(e.target)) ? !1 : this.callEvent("onBeforeLinkDisplay", [t, e]) : !1 }, gantt._is_std_background = function() {
        return !this.config.static_background }, gantt._delete_link_handler = function(t, e) {
        if (t && this.callEvent("onLinkDblClick", [t, e])) {
            ...
            window.setTimeout(function() { gantt._dhtmlx_confirm(i, a, function() { gantt.deleteLink(t) }) }, gantt.config.touch ? 300 : 1)
        }
    }, gantt.getTaskNode = function(t) {
        return this._taskRenderer.rendered[t] }, gantt.getLinkNode = function(t) {
        return this._linkRenderer.rendered[t] }, gantt._get_tasks_data = function() {
        ...
        return this._order }, gantt._get_links_data = function() {
        return this._links.slice() }, gantt._render_data = function() {
        ...
        if (this.config.scale_offset_minimal) {
            ...
            t = e[e.length - 1].unit }
        return t }, gantt._init_tasks_range = function() {
        var t = this._scale_range_unit();
        if (this.config.start_date && this.config.end_date) { this._min_date = this.date[t + "_start"](new Date(this.config.start_date));
        ...
        for (var s = 0; s < t.count; s++) {
            ...
            var r = a.call(this, n),
                ...
                d = "",
                l = "";
            if (o) { _ = "width:" + o + "px;", l = "gantt_scale_cell" + (s == t.count - 1 ? " gantt_last_cell" : ""), d = i.call(this, n), d && (l += " " + d);
        ...
        return t.sortScales(e), e }, gantt._render_tasks_scales = function() {
        ...
        return !1 }, gantt.refreshTask = function(t, e) {
        ...
        var i = gantt.getState(); + n.end_date <= +i.max_date && t.appendChild(a(e + " task_right")), +n.start_date >= +i.min_date && t.appendChild(a(e + " task_left")) }, gantt._get_task_height = function() {
        ...
        return this._get_task_height() }, gantt._get_visible_milestone_width = function() {
        var t = gantt._get_task_height();
        return Math.sqrt(2 * t * t) }, gantt.getTaskPosition = function(t, e, n) {
        var a = this.posFromDate(e || t.start_date),
            i = this.posFromDate(n || t.end_date);
        i = Math.max(a, i);
        var s = this.getTaskTop(t.id),
            r = gantt._get_task_height();
        return { left: a, top: s, height: r, width: Math.max(i - a, 0) } }, gantt._get_task_width = function(t, e, n) {
        return Math.round(this._get_task_pos(t, !1).x - this._get_task_pos(t, !0).x);
    }, gantt._is_readonly = function(t) {
        return t && t[this.config.editable_property] ? !1 : t && t[this.config.readonly_property] || this.config.readonly }, gantt._task_default_render = function(t) {
        if (!this._isAllowedUnscheduledTask(t)) {
            ...
            return g && s.appendChild(g), g = this._render_rightside_content(t), g && s.appendChild(g), this._is_readonly(t) || (n.drag_resize && !this._is_flex_task(t) && o != this.config.types.milestone && gantt._render_pair(s, "gantt_task_drag", t, function(t) {
                ...
                return e.className = t, e }), n.drag_links && this.config.show_links && gantt._render_pair(s, "gantt_link_control", t, function(t) {
                var e = document.createElement("div");
        ...
        return n || (n = a), n.call(this, t, this.bind(a, this)) }, gantt._render_side_content = function(t, e, n) {
        if (!e) return null;
        ...
        return gantt._render_side_content(t, this.templates.leftside_text, e) }, gantt._render_rightside_content = function(t) {
        var e = "gantt_right " + gantt._get_link_crossing_css(!1, t);
        return gantt._render_side_content(t, this.templates.rightside_text, e) }, gantt._get_conditions = function(t) {
        return t ? {
            $source: [gantt.config.links.start_to_start],
            $target: [gantt.config.links.start_to_start, gantt.config.links.finish_to_start]
        } : { $source: [gantt.config.links.finish_to_start, gantt.config.links.finish_to_finish], $target: [gantt.config.links.finish_to_finish] }
        ...
        return "" }, gantt._render_task_content = function(t, e) {
        var n = document.createElement("div");
        ...
        return e[t] || 0 }, gantt.dateFromPos = function(t) {
        var e = this._tasks;
        ...
        return n == gantt._tasks.width.length && (i += gantt._tasks.width[gantt._tasks.width.length - 1]), a && (i += n < gantt._tasks.width.length ? gantt._tasks.width[n] * (a % 1) : 1), i }, gantt._day_index_by_date = function(t) {
        ...
        for (var n, a, i, s = 0, r = t.length - 1; r >= s;)
            if (n = Math.floor((s + r) / 2), a = +t[n], i = +t[n - 1], e > a) s = n + 1;
                ...
                r = n - 1 }
        return t.length - 1 }, gantt._get_coll_duration = function(t, e) {
        return gantt.date.add(e, t.step, t.unit) - e }, gantt._get_x_pos = function(t, e) {
        e = e !== !1;
        gantt.posFromDate(e ? t.start_date : t.end_date);
    }, gantt.getTaskTop = function(t) {
        return this._y_from_ind(this.getGlobalTaskIndex(t)) }, gantt._get_task_coord = function(t, e, n) { e = e !== !1, n = n || 0;
        ...
        return a && (e ? s -= n : s += n), { x: s, y: r } }, gantt._get_task_pos = function(t, e) {
        e = e !== !1;
        var n = gantt._get_milestone_width() / 2;
        return this._get_task_coord(t, e, n);
    }, gantt._get_task_visible_pos = function(t, e) { e = e !== !1;
        var n = gantt._get_visible_milestone_width() / 2;
        return this._get_task_coord(t, e, n) }, gantt._correct_shift = function(t, e) {
        return t -= 6e4 * (new Date(gantt._min_date).getTimezoneOffset() - new Date(t).getTimezoneOffset()) * (e ? -1 : 1) }, gantt._get_mouse_pos = function(t) {
        ...
        return t && t.hasAttribute && t.hasAttribute(this.config.layer_attribute) }, gantt.attachEvent("onGanttReady", function() { gantt._task_layers.add(), gantt._link_layers.add() }), gantt._layers = {
        ...
        return t instanceof Array || (t = Array.prototype.slice.call(arguments, 0)),
            function(e) {
                ...
                return n } }, gantt._add_generic_layer = function(t, e) {
        return function(n) {
        ...
        return gantt.$task_data }, function() {
        return gantt.$task_links }), gantt._link_layers = gantt._layers.create(function() {
        return gantt.$task_data }), gantt.addTaskLayer = gantt._add_generic_layer(gantt._task_layers, [gantt._filter_task, gantt._is_chart_visible].concat(gantt._get_task_filters())), gantt.removeTaskLayer = function(t) { gantt._task_layers.remove(t) }, gantt.addLinkLayer = gantt._add_generic_layer(gantt._link_layers, [gantt._filter_link, gantt._is_chart_visible].concat(gantt._get_link_filters())),
    gantt.removeLinkLayer = function(t) { gantt._link_layers.remove(t) }, gantt._get_task_renderers = function() {
        return this._task_layers.getRenderers() }, gantt._get_link_renderers = function() {
        return this._link_layers.getRenderers() }, gantt._pull = {}, gantt._branches = {}, gantt._order = [], gantt._lpull = {}, gantt._links = [], gantt._order_full = [], gantt.load = function(t, e, n) {
        ...
        arguments.length >= 3 ? (a = e, i = n) : "string" == typeof arguments[1] ? a = arguments[1] : "function" == typeof arguments[1] && (i = arguments[1]),
            this._load_type = a, this.ajax.get(t, gantt.bind(function(t) { this.on_load(t, a), this.callEvent("onLoadEnd", []), "function" == typeof i && i.call(this) }, this))
    }, gantt.parse = function(t, e) { this.on_load({ xmlDoc: { responseText: t } }, e) }, gantt.serialize = function(t) {
        return t = t || "json", this[t].serialize() }, gantt.on_load = function(t, e) { this.callEvent("onBeforeParse", []), e || (e = "json"), this.assert(this[e], "Invalid data type:'" + e + "'");
        var n = t.xmlDoc.responseText,
            a = this[e].parse(n, t);
        this._process_loading(a) }, gantt._load_task = function(t) {
        ...
        return n }, gantt._build_hierarchy = function(t) {
        for (var e = null, n = 0, a = t.length; a > n; n++) e = t[n], this.setParent(e, this.getParent(e) || this.config.root_id);
        for (var n = 0, a = t.length; a > n; n++) e = t[n], this._add_branch(e), e.$level = this.calculateTaskLevel(e) }, gantt._process_loading = function(t) {
        ...
        return !e.$ignore }), gantt._sync_order_item = function(t, e) { t.id && (this._order_full.push(t.id), !e && this._filter_task(t.id, t) && this.callEvent("onBeforeTaskDisplay", [t.id, t]) && (this._order.push(t.id), this._order_search[t.id] = this._order.length - 1));
        var n = this.getChildren(t.id);
        if (n)
            for (var a = 0; a < n.length; a++) this._sync_order_item(this._pull[n[a]], e || !t.$open) }, gantt.getTaskCount = function() {
        return this._order_full.length }, gantt.getLinkCount = function() {
        return this._links.length
    }, gantt.getVisibleTaskCount = function() {
        return this._order.length }, gantt.getTaskIndex = function(t) {
        for (var e = this.getChildren(this.getParent(t)), n = 0; n < e.length; n++)
            if (e[n] == t) return n;
        return -1 }, gantt.getGlobalTaskIndex = function(t) { this.assert(t, "Invalid argument");
        var e = this._order_search[t];
        return void 0 !== e ? e : -1 }, gantt._get_visible_order = gantt.getGlobalTaskIndex, gantt.eachTask = function(t, e, n) {
        ...
        serialize: function() {
            var t = [],
                e = [];
            return gantt.eachTask(function(e) { gantt.resetProjectDates(e), t.push(this._copyObject(e)) }, gantt.config.root_id, this), e = gantt._links.slice(), { data: t, links: e } }
    }, gantt.xml = {
        ...
        _getCollections: function(t) {
            for (var e = {}, n = gantt.ajax.xpath("//coll_options", t), a = 0; a < n.length; a++)
                for (var i = n[a].getAttribute("for"), s = e[i] = [], r = gantt.ajax.xpath(".//item", n[a]), o = 0; o < r.length; o++) {
                    for (var _ = r[o], d = _.attributes, l = { key: r[o].getAttribute("value"), label: r[o].getAttribute("label") }, g = 0; g < d.length; g++) {
                        var h = d[g]; "value" != h.nodeName && "label" != h.nodeName && (l[h.nodeName] = h.nodeValue) }
                    s.push(l) }
            return e },
        ...
        parse: function(t, e) { e = this._getXML(t, e);
        ...
        return e ? this.serverList[t] = e.slice(0) : this.serverList[t] || (this.serverList[t] = []), this.serverList[t] }, gantt._working_time_helper = {
        ...
        unset_time: function(t) {
            if (t) {
                ...
                null !== e && delete this.dates[e] } else this.hours = [];
    ...
    }, gantt.getTask = function(t) { gantt.assert(t, "Invalid argument for gantt.getTask");
        var e = this._pull[t];
        return gantt.assert(e, "Task not found id=" + t), e }, gantt.getTaskByTime = function(t, e) {
        var n = this._pull,
            a = [];
        if (t || e) { t = +t || -(1 / 0), e = +e || 1 / 0;
            for (var i in n) {
                var s = n[i]; + s.start_date < e && +s.end_date > t && a.push(s) } } else
            for (var i in n) a.push(n[i]);
        return a
    }, gantt.isTaskExists = function(t) {
        return gantt.defined(this._pull[t]) }, gantt.isUnscheduledTask = function(t) {
        return !!t.unscheduled || !t.start_date }, gantt._isAllowedUnscheduledTask = function(t) {
        return t.unscheduled && gantt.config.show_unscheduled }, gantt.isTaskVisible = function(t) {
        ...
        return gantt.defined(e) || (e = this.getTask(t)), this.callEvent("onBeforeTaskUpdate", [t, e]) === !1 ? !1 : (this._pull[e.id] = e, this._is_parent_sync(e) || this._resync_parent(e), this._isAllowedUnscheduledTask(e) && (this._init_task(e), this._sync_links()), this._update_parents(e.id), this.refreshTask(e.id), this.callEvent("onAfterTaskUpdate", [t, e]), this._sync_order(), void this._adjust_scales()) }, gantt._add_branch = function(t, e) {
    ...
    }, gantt._move_branch = function(t, e, n) { this.setParent(t, n), this._sync_parent(t), this._replace_branch_child(e, t.id), this.isTaskExists(n) || n == this.config.root_id ? this._add_branch(t) : delete this._branches[t.id], t.$level = this.calculateTaskLevel(t), this._sync_order() }, gantt._resync_parent = function(t) { this._move_branch(t, t.$rendered_parent, this.getParent(t)) },
    gantt._sync_parent = function(t) { t.$rendered_parent = this.getParent(t) }, gantt._is_parent_sync = function(t) {
        return t.$rendered_parent == this.getParent(t) }, gantt._replace_branch_child = function(t, e, n) {
        var a = this.getChildren(t);
        if (a) {
            for (var i = [], s = 0; s < a.length; s++) a[s] != e ? i.push(a[s]) : n && i.push(n);
            this._branches[t] = i }
        this._sync_order() }, gantt.addTask = function(t, e, n) {
        ...
        return this._deleteTask(t) }, gantt._getChildLinks = function(t) {
        ...
        return n }, gantt._deleteRelatedLinks = function(t, e) {
        var n = this._dp && !e,
            a = "",
        ...
        n && this._dp.setUpdateMode(a) }, gantt._unset_task = function(t) {
        var e = this.getTask(t);
        ...
        return this._deleteRelatedTasks(t, e), this._deleteRelatedLinks(a, e), this._unset_task(t), e || (this.callEvent("onAfterTaskDelete", [t, n]), this.refreshData()), !0 }, gantt.clearAll = function() { this._clear_data(), this.callEvent("onClear", []), this.refreshData() }, gantt._clear_data = function() {
        ...
        var e = [];
        return t.$source && (e = e.concat(t.$source)), t.$target && (e = e.concat(t.$target)), e }, gantt._get_duration_unit = function() {
        return 1e3 * gantt._get_line(this.config.duration_unit) || this.config.duration_unit;
    }, gantt._get_safe_type = function(t) {
        return "task" }, gantt._get_type_name = function(t) {
        for (var e in this.config.types)
            if (this.config.types[e] == t) return e;
        return "task" }, gantt.getWorkHours = function(t) {
        return this._working_time_helper.get_working_hours(t) }, gantt.setWorkTime = function(t) { this._working_time_helper.set_time(t) }, gantt.isWorkTime = function(t, e) {
        var n = this._working_time_helper;
        return n.is_working_unit(t, e || this.config.duration_unit) }, gantt.correctTaskWorkTime = function(t) {
        ...
        return t instanceof Date && (t = { date: t }), t.dir = t.dir || "any", t.unit = t.unit || this.config.duration_unit, e.get_closest_worktime(t) }, gantt.calculateDuration = function(t, e) {
        var n = this._working_time_helper;
        return n.get_work_units_between(t, e, this.config.duration_unit, this.config.duration_step) }, gantt._hasDuration = function(t, e) {
        var n = this._working_time_helper;
        ...
        var a = this._working_time_helper,
            i = e >= 0 ? 1 : -1;
        return a.add_worktime(t, Math.abs(e), n || this.config.duration_unit, i * this.config.duration_step) }, gantt._init_task = function(t) {
    ...
    gantt._is_flex_task = function(t) {
        return !(!t.$no_end && !t.$no_start) }, gantt.resetProjectDates = function(t) {
    ...
    }, gantt._assign_project_dates = function(t, e, n) { t.$no_start && (e && e != 1 / 0 ? t.start_date = new Date(e) : t.start_date = this._default_task_date(t, this.getParent(t))), t.$no_end && (n && n != -(1 / 0) ? t.end_date = new Date(n) : t.end_date = this.calculateEndDate(t.start_date, this.config.duration_step)), (t.$no_start || t.$no_end) && this._init_task_timing(t) }, gantt._update_parents = function(t, e) {
        if (t) {
            var n = this.getTask(t),
                a = this.getParent(n),
                i = !0;
        ...
        if (r == gantt._tasks.unit && s == gantt._tasks.step && +i >= +gantt._min_date && +i <= +gantt._max_date) a = Math.floor(gantt._day_index_by_date(i)), gantt._tasks.trace_x[a] || (a -= 1), n = new Date(gantt._tasks.trace_x[a]), e = new Date(n), e = gantt._tasks.trace_x[a + 1] ? new Date(gantt._tasks.trace_x[a + 1]) : gantt.date.add(n, s, r);
            ...
            for (a = Math.floor(gantt._day_index_by_date(i)),
                e = gantt.date[r + "_start"](new Date(this._min_date)), gantt._tasks.trace_x[a] && (e = gantt.date[r + "_start"](gantt._tasks.trace_x[a])); + i > +e;) { e = gantt.date[r + "_start"](gantt.date.add(e, s, r));
        ...
        return gantt._init_task_timing(e), !0 }), gantt.calculateTaskLevel = function(t) {
        for (var e = 0; this.getParent(t) && this.isTaskExists(this.getParent(t));) t = this.getTask(this.getParent(t)), e++;
        return e }, gantt.sort = function(t, e, n, a) {
        var i = !a;
        ...
        return null }, gantt.getPrev = function(t) {
        for (var e = 1; e < this._order.length; e++)
            if (this._order[e] == t) return this._order[e - 1];
        return null }, gantt._get_parent_id = function(t) {
        var e = this.config.root_id;
        return t && (e = t.parent), e }, gantt.getParent = function(t) {
        var e = null;
        return e = t.id ? t : gantt.getTask(t), this._get_parent_id(e)
    }, gantt.setParent = function(t, e) { t.parent = e }, gantt.getSiblings = function(t) {
        if (!this.isTaskExists(t)) return [];
        var e = this.getParent(t);
        return this.getChildren(e) }, gantt.getNextSibling = function(t) {
        for (var e = this.getSiblings(t), n = 0, a = e.length; a > n; n++)
            if (e[n] == t) return e[n + 1] || null;
        return null }, gantt.getPrevSibling = function(t) {
        for (var e = this.getSiblings(t), n = 0, a = e.length; a > n; n++)
            if (e[n] == t) return e[n - 1] || null;
            ...
            if (t._waitMode) {
                ...
                if (d.length) { n = n || {};
                    for (var r = 0; r < d.length; r++) {
                        ...
                        n[l.id] = l } } } }), t.attachEvent("onAfterUpdateFinish", function() {
        ...
        return this.userdata || (this.userdata = {}), this.userdata[t] && this.userdata[t][e] ? this.userdata[t][e] : "" }, gantt.setUserData = function(t, e, n) { this.userdata || (this.userdata = {}), this.userdata[t] || (this.userdata[t] = {}), this.userdata[t][e] = n }, gantt._init_link = function(t) {
        return gantt.defined(t.id) || (t.id = gantt.uid()), t }, gantt._sync_links = function() {
        ...
        return gantt.assert(this._lpull[t], "Link doesn't exist"), this._lpull[t] }, gantt.getLinks = function() {
        var t = [];
        for (var e in gantt._lpull) t.push(gantt._lpull[e]);
        return t }, gantt.isLinkExists = function(t) {
        return gantt.defined(this._lpull[t]) }, gantt.addLink = function(t) {
        ...
        return gantt.defined(e) || (e = this.getLink(t)), this.callEvent("onBeforeLinkUpdate", [t, e]) === !1 ? !1 : (this._lpull[t] = e, this._sync_links(), this._render_link(t), this.callEvent("onAfterLinkUpdate", [t, e]), !0) }, gantt.deleteLink = function(t) {
        return this._deleteLink(t) }, gantt._deleteLink = function(t, e) {
    ...
    }, gantt.changeLinkId = function(t, e) { this._lpull[t] && (this._lpull[e] = this._lpull[t], this._lpull[e].id = e, delete this._lpull[t], this._sync_links(), this.callEvent("onLinkIdChange", [t, e])) }, gantt.getChildren = function(t) {
        return gantt.defined(this._branches[t]) ? this._branches[t] : [] }, gantt.hasChild = function(t) {
        return gantt.defined(this._branches[t]) && this._branches[t].length;
    }, gantt.refreshData = function() { this._render_data() }, gantt._isTask = function(t) {
        return !(t.type && t.type == gantt.config.types.project || t.$no_start || t.$no_end) }, gantt._isProject = function(t) {
        return !this._isTask(t) }, gantt._configure = function(t, e, n) {
        for (var a in e)("undefined" == typeof t[a] || n) && (t[a] = e[a]) }, gantt._init_skin = function() { gantt._get_skin(!1), gantt._init_skin = function() {} }, gantt._get_skin = function(t) {
        if (!gantt.skin || t)
    ...
    }, gantt.resetSkin = function() { this.skin = "", this._get_skin(!0) }, gantt.skins = {}, gantt._lightbox_methods = {},
    gantt._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", gantt.showLightbox = function(t) {
        ...
        return "" }, gantt.updateCollection = function(t, e) {
        e = e.slice(0);
        var n = gantt.serverList(t);
        return n ? (n.splice(0, n.length), n.push.apply(n, e || []),
            void gantt.resetLightbox()) : !1
    }, gantt.getLightboxType = function() {
        return this._get_safe_type(this._lightbox_type) }, gantt.getLightbox = function(t) {
        if (void 0 === t && (t = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
            ...
            for (var a = this._lightbox_template, i = this.config.buttons_left, s = 0; s < i.length; s++) {
                ...
                a += "<div class='gantt_btn_set gantt_left_btn_set " + r + "_set' style='float:right'><div dhx_button='1' class='" + r + "'></div><div>" + this.locale.labels[r] + "</div></div>" }
            ...
            a += "</div>", e.innerHTML = a, gantt.config.drag_lightbox && (e.firstChild.onmousedown = gantt._ready_to_dnd, e.firstChild.onselectstart = function() {
                return !1 }, e.firstChild.style.cursor = "pointer", gantt._init_dnd_events()), document.body.insertBefore(e, document.body.firstChild), this._lightbox = e;
            var o = this._get_typed_lightbox_config(t);
            a = this._render_sections(o);
            for (var _ = e.getElementsByTagName("div"), s = 0; s < _.length; s++) {
                var d = _[s];
                if ("gantt_cal_larea" == d.className) { d.innerHTML = a;
                    break } }
     ...
     gantt._init_lightbox_events = function() {
        ...
        return n[t.type] && ("auto" == t.map_to ? e = { start_date: "start_date", end_date: "end_date", duration: "duration" } : "string" == typeof t.map_to && (e = { start_date: t.map_to })), e }, gantt.getLightboxValues = function() {
        var t = {};
        ...
        t && (t.style.display = "none"), this._lightbox_id = null, this.hideCover(), this.callEvent("onAfterLightbox", []) }, gantt.hideCover = function() {
        this._cover && this._cover.parentNode.removeChild(this._cover),
            this._cover = null
    }, gantt.resetLightbox = function() { gantt._lightbox && !gantt._custom_lightbox && gantt._lightbox.parentNode.removeChild(gantt._lightbox), gantt._lightbox = null }, gantt._set_lightbox_values = function(t, e) {
        var n = t,
        ...
        var n = this.getTask(t);
        this._set_lightbox_values(n, e) }, gantt.getLightboxSection = function(t) {
        ...
        var i = document.getElementById(a.id),
            s = i.nextSibling,
            r = { section: a, header: i, node: s, getValue: function(t) {
                    return gantt.form_blocks[a.type].get_value.call(gantt, s, t || {}, a) }, setValue: function(t, e) {
        ...
        return t.control = t.node.getElementsByTagName("select")[0], t }, gantt._lightbox_methods.get_textarea_control = function(t) {
        return t.control = t.node.getElementsByTagName("textarea")[0], t }, gantt._lightbox_methods.get_time_control = function(t) {
        return t.control = t.node.getElementsByTagName("select"), t }, gantt._init_dnd_events = function() {
        ...
        if (gantt._dnd_start_lb) { document.gantt_unselectable || (document.body.className += " gantt_unselectable", document.gantt_unselectable = !0);
    ...
    }, gantt._finish_dnd = function() { gantt._lb_start && (gantt._lb_start = gantt._dnd_start_lb = !1, document.body.className = document.body.className.replace(" gantt_unselectable", ""), document.gantt_unselectable = !1) }, gantt._focus = function(t, e) {
        if (t && t.focus)
        ...
        template: { render: function(t) {
                ...
                return "<div class='gantt_cal_ltext gantt_cal_template' style='height:" + e + ";'></div>" }, set_value: function(t, e, n, a) { t.innerHTML = e || "" }, get_value: function(t, e, n) {
                return t.innerHTML || "" }, focus: function(t) {} },
        textarea: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><textarea></textarea></div>";
            },
            set_value: function(t, e, n) { t.firstChild.value = e || "" },
        ...
        time: {
            ...
            set_value: function(t, e, n, a) {
                ...
                a._time_format_size;
                if (i.auto_end_date)
                    for (var o = function() { l = new Date(s[r[2]].value, s[r[1]].value, s[r[0]].value, 0, 0), g = gantt.calculateEndDate(l, 1), this.form_blocks._fill_lightbox_select(s, r.size, g, r, i) }, _ = 0; 4 > _; _++) s[_].onchange = o;
            ...
            get_value: function(t, e, n) {
                ...
                var l = gantt._resolve_default_mapping(n),
                    g = { start_date: new Date(_), end_date: new Date(d) };
        ...
        duration: {
            ...
            set_value: function(t, e, n, a) {
                ...
                }, this), l[1].onclick = gantt.bind(function() { s(1 * this.config.duration_step) }, this), o[0].onchange = i, o[1].onchange = i, o[2].onchange = i, o[3] && (o[3].onchange = i), d.onkeydown = gantt.bind(function(t) { t = t || window.event;
                    var e = t.charCode || t.keyCode || t.which;
                    return 40 == e ? (s(-1 * this.config.duration_step), !1) : 38 == e ? (s(1 * this.config.duration_step), !1) : void window.setTimeout(function(t) { i() }, 1) }, this), d.onchange = gantt.bind(function(t) { i() }, this);
        ...
        return !1 }, gantt._dhtmlx_confirm = function(t, e, n, a) {
        if (!t) return n();
        var i = { text: t };
        ...
        var e = t,
            n = {
                ...
                set_value: function(t, a, i, s) {
                    ...
                    if (!i[r.start_date] || "start_date" == r.start_date && this._isAllowedUnscheduledTask(i)) { n.disable(t, s);
                        var o = {};
        ...
        set_invalid: function(t, e, n) { n && (e = { value: e, details: n, toString: function() {
                    return this.value.toString() } }), this._invalid[t] = e },
        ...
        setVerificator: function(t, e) { this.mandatoryFields[t] = e || function(t) {
                return "" !== t } },
        ...
        var i = { "delete": gantt.deleteTask, isExist: gantt.isTaskExists }; "links" == a && (i["delete"] = gantt.deleteLink, i.isExist = gantt.isLinkExists), i.isExist.call(gantt, e) && i["delete"].call(gantt, e) }, gantt.assert = function(t, e) { t || gantt.config.show_errors && gantt.callEvent("onError", [e]) !== !1 && gantt.message({ type: "error", text: e, expire: -1 }) }, gantt.init = function(t, e, n) {
        this.callEvent("onBeforeGanttReady", []), e && n && (this.config.start_date = this._min_date = new Date(e),
            this.config.end_date = this._max_date = new Date(n)), this._init_skin(), this.date.init(), this.config.scroll_size || (this.config.scroll_size = this._detectScrollSize()), gantt.event(window, "resize", this._on_resize), this.init = function(t) { this.$container && this.$container.parentNode && (this.$container.parentNode.removeChild(this.$container), this.$container = null), this._reinit(t) }, this._reinit(t)
        ...
        return this._is_chart_visible() || (e = 0), this._is_grid_visible() || (t = 0), t + e + 1 }, gantt._get_resize_options = function() {
        var t = { x: !1, y: !1 };
        return "xy" == this.config.autosize ? t.x = t.y = !0 : "y" == this.config.autosize || this.config.autosize === !0 ? t.y = !0 : "x" == this.config.autosize && (t.x = !0), t }, gantt._clean_el_size = function(t) {
        ...
        var n = {};
        this._cached_scroll_pos = this._cached_scroll_pos || {}, void 0 !== t && (n.x = Math.max(t, 0)), void 0 !== e && (n.y = Math.max(e, 0)), this.mixin(this._cached_scroll_pos, n, !0) }, gantt._restore_scroll_state = function() {
        var t = { x: 0, y: 0 };
        return this._cached_scroll_pos && (t.x = this._cached_scroll_pos.x || t.x, t.y = this._cached_scroll_pos.y || t.y), t }, gantt.scrollTo = function(t, e) {
    ...
    }, gantt._on_resize = gantt.setSizes = function() { gantt._set_sizes(), gantt._scroll_resize() }, gantt.render = function() {
        if (this._is_render_active()) {
        ...
        this.event(this.$scroll_hor, "scroll", function() {
            ...
            if (!gantt._touch_scroll_active) {
                ...
                gantt.scrollTo(t) } }), this.event(this.$scroll_ver, "scroll", function() {
            if (!gantt._touch_scroll_active) {
        ...
        if (!t) return "";
        var e = t.className || "";
        return e.baseVal && (e = e.baseVal), e.indexOf || (e = ""), gantt._trim(e) }, gantt.locate = function(t) {
        ...
        for (var a = arguments[1] || this.config.task_attribute; e;) {
            if (e.getAttribute) {
                ...
                if (i) return i }
            e = e.parentNode }
        return null }, gantt._get_target_node = function(t) {
        var e;
        ...
        return e.apply(t) }, gantt._locate_css = function(t, e, n) { void 0 === n && (n = !0);
        for (var a = gantt._get_target_node(t), i = ""; a;) {
            if (i = gantt._getClassName(a)) {
                ...
                if (s >= 0) {
                    ...
                    if (r && o) return a } }
            a = a.parentNode }
        return null }, gantt._locateHTML = function(t, e) {
        ...
        if (!e) return !0;
        var n = 1e3 / e;
        return 1 > n ? !0 : t._on_timeout ? !1 : (setTimeout(function() { delete t._on_timeout }, n), t._on_timeout = !0, !0) }, gantt.selectTask = function(t) {
        ...
        t && (this._selected_task = null, this.refreshTask(t), this.callEvent("onTaskUnselected", [t])) }, gantt.getSelectedId = function() {
        return this.defined(this._selected_task) ? this._selected_task : null }, gantt.changeLightboxType = function(t) {
        return this.getLightboxType() == t ? !0 : void gantt._silent_redraw_lightbox(t) }, gantt._is_render_active = function() {
        ...
        return t }, gantt.batchUpdate = function(t, e) {
        ...
        this.resetProjectDates = function(t) { o[t.id] = t }, this._skip_render = !0, this.callEvent("onBeforeBatchUpdate", []);
        try { t() } catch (d) {}
    ...
    function() {
        ...
        function s(e, n, i) {
            ...
            if (r += "</div>", s.innerHTML = r, e.content) {
                var _ = e.content; "string" == typeof _ && (_ = document.getElementById(_)), "none" == _.style.display && (_.style.display = ""), s.childNodes[e.title ? 1 : 0].appendChild(_) }
            return s.onclick = function(n) { n = n || event;
                var a = n.target || n.srcElement;
                if (a.className || (a = a.parentNode), "gantt_popup_button" == a.className.split(" ")[0]) {
                    var i = a.getAttribute("result");
                    i = "true" == i || ("false" == i ? !1 : i), t(e, i) } }, e.box = s, (n || i) && (h = e), s
        }
        ...
        function g(t, e, n, a) {
            return "object" != typeof t && (t = { text: t, type: e, expire: n, id: a }), t.id = t.id || c.uid(), t.expire = t.expire || c.expire, t }
        var h = null;
        document.attachEvent ? document.attachEvent("onkeydown", e) : document.addEventListener("keydown", e, !0), gantt.alert = function() {
            ...
            return t.type = t.type || "confirm", o(t) }, gantt.confirm = function() {
            var t = l.apply(this, arguments);
            return t.type = t.type || "alert", _(t) }, gantt.modalbox = function() {
            var t = l.apply(this, arguments);
        ...
        var c = gantt.message = function(t, e, n, a) { t = g.apply(this, arguments), t.type = t.type || "info";
        ...
        c.seed = (new Date).valueOf(), c.uid = function() {
                return c.seed++ }, c.expire = 4e3, c.keyboard = !0, c.position = "top",
            c.pull = {}, c.timers = {}, c.hideAll = function() {
                for (var t in c.pull) c.hide(t) }, c.hide = function(t) {
                var e = c.pull[t];
                e && e.parentNode && (window.setTimeout(function() { e.parentNode.removeChild(e), e = null }, 2e3), e.className += " hidden", c.timers[t] && window.clearTimeout(c.timers[t]), delete c.pull[t]) }
    }(), gantt.date = {
        init: function() {
    ...
    }, gantt.date.quarter_start = function(t) { gantt.date.month_start(t);
        var e, n = t.getMonth();
        return e = n >= 9 ? 9 : n >= 6 ? 6 : n >= 3 ? 3 : 0, t.setMonth(e), t }, gantt.date.add_quarter = function(t, e) {
        return gantt.date.add(t, 3 * e, "month") }, gantt.config || (gantt.config = {}), gantt.config || (gantt.config = {}), gantt.templates || (gantt.templates = {}),
    function() {
        gantt.mixin(gantt.config, {
            ...
            drag_move: !0,
            drag_mode: {
             //taha  resize: "resize", progress: "progress", move: "move", ignore: "ignore" 
         },
            round_dnd_dates: !0,
            ...
            lightbox: {
                ...
                project_sections: [{ name: "description", height: 70, map_to: "text", type: "textarea", focus: !0 }, { name: "type", type: "typeselect", map_to: "type" }, { name: "time", type: "duration", readonly: !0, map_to: "auto" }],
    ...
    }, gantt.config.touch_drag = 500, gantt.config.touch = !0, gantt.config.touch_feedback = !0, gantt._touch_feedback = function() { gantt.config.touch_feedback && navigator.vibrate && navigator.vibrate(1) }, gantt._init_touch_events = function() {
        "force" != this.config.touch && (this.config.touch = this.config.touch && (-1 != navigator.userAgent.indexOf("Mobile") || -1 != navigator.userAgent.indexOf("iPad") || -1 != navigator.userAgent.indexOf("Android") || -1 != navigator.userAgent.indexOf("Touch"))),
            this.config.touch && (window.navigator.msPointerEnabled ? this._touch_events(["MSPointerMove", "MSPointerDown", "MSPointerUp"], function(t) {
                return t.pointerType == t.MSPOINTER_TYPE_MOUSE ? null : t }, function(t) {
                return !t || t.pointerType == t.MSPOINTER_TYPE_MOUSE }) : this._touch_events(["touchmove", "touchstart", "touchend"], function(t) {
                return t.touches && t.touches.length > 1 ? null : t.touches[0] ? { target: t.target, pageX: t.touches[0].pageX, pageY: t.touches[0].pageY, clientX: t.touches[0].clientX, clientY: t.touches[0].clientY } : t }, function() {
                return !1
            }))
        ...
        this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1,
            ...
            return o ? a(t) : void 0 }), gantt.event(this.$container, t[1], function(t) {
            if (!n(t)) {
                if (t.touches && t.touches.length > 1) return void(o = !1);
                if (o = !0, d = e(t), d && r) {
                    var s = new Date;
                    500 > s - r ? (gantt._on_dblclick(d), a(t)) : r = s } else r = new Date;
            ...
            if (!n(t)) { l && clearTimeout(l), gantt._touch_drag = !1, o = !1;
                var a = e(t);
